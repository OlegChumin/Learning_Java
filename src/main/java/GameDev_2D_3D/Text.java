...
public class Text {
	...
	void makeLivesLabel() {
		...
		lives_text_label.setBounds(ArkanoidGameStart.WIDTH-103, -33, ArkanoidGameStart.WIDTH, 100); lives_label.setBounds(ArkanoidGameStart.WIDTH-22, -33, ArkanoidGameStart.WIDTH, 100);
